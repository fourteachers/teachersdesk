...
class recent_Posts_Widget extends WP_Widget {
	...
	function recent_Posts_Widget() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'recent-posts-widget', 'Recent Posts', $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		foreach ($posts as $post) {
			...
			//if ($post_number == $number) ? $entry_without_border = ' style="border-bottom:0px;"' : $entry_without_border = '';
			$entry_without_border = ($post_number == $number) ? ' style="border-bottom:0px;"' : '';
